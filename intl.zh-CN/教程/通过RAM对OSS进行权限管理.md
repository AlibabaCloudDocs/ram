...
-   使用RAM对OSS进行权限管理前，请先了解OSS的权限定义。更多信息，请参见[RAM Policy概述](/intl.zh-CN/开发指南/数据安全/访问控制/RAM Policy/RAM Policy概述.md)。
...
2.  创建自定义策略。
    ...
    更多信息，请参见[创建自定义策略](/intl.zh-CN/权限策略管理/自定义策略/创建自定义策略.md)和[权限策略示例](#section_mlc_ww2_vgb)。
